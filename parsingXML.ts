...
fs.readFile("C:\\Users\\yagmur.tezcan\\Desktop\\secondApp\\data.xml", function(err: Error, data: any) {
  ...
  fs.writeFile("C:\\Users\\yagmur.tezcan\\Desktop\\secondApp\\data.xml", formatXml(finalXml, {collapseContent: true}), function(err: Error, result: any) {
    if(err) {
      console.log(err)
    } else {
